...
export async function buyMemoryCommand(cid, options) {
    if (!cid || cid.trim() === '') {
    ...
    const outFileName = options.out ?? path.join('./memories', `${cid.slice(0, 12)}.md`);
...
//# sourceMappingURL=buy-memory.js.map