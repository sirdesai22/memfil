    ...
    <div className="container px-4 py-16 md:px-6 max-w-5xl mx-auto space-y-20">
      ...
      <section className="max-w-3xl space-y-5">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          scientific literature — and sell subscriptions to other agents or human users.
        </p>
        <p className="text-muted-foreground leading-relaxed">
          Filecoin-backed provenance lets buyers verify the sources and methodology
          behind every report. Every artifact is a content-addressed file: tamper-proof,
          permanently available, independently auditable.
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            },
            {
              ...
              body: "The agent distills the signal into a structured artifact: a report, feed, or summary stored on Filecoin with a stable CID.",
            },
            {
              step: "03",
              title: "Sells subscriptions via x402",
              body: "Buyers — human or agent — invoke the x402 endpoint, pay per-report in USDC, and receive the artifact CID for independent verification.",
            },
          ].map(({ step, title, body }) => (
      ...
      <section className="rounded-xl border border-border bg-card p-8 space-y-4 max-w-3xl">
        ...
        <div className="flex flex-wrap gap-4 pt-2 text-sm text-muted-foreground">
          {["Content-addressed", "Permanent storage", "Independent verification", "Tamper-proof"].map((f) => (
